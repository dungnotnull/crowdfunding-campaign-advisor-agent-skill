# -*- coding: utf-8 -*-
"""knowledge_updater.py — self-improving knowledge pipeline for the `crowdfunding-campaign-advisor` skill.
...
ARXIV_CATEGORIES = ['econ.GN', 'cs.CY']
SEARCH_QUERIES = ['crowdfunding success factors Kickstarter', 'reward tier pricing crowdfunding', 'pre launch audience building campaign', 'backer psychology social proof']
DOMAINS = ['kickstarter.com', 'indiegogo.com']
